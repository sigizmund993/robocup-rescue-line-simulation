...
while robot.step(timeStep) != -1:
    ...
    for i in contours:
        print(frame[i[0][0][1],i[0][0][0]-1])
        print(i[0][0])
        pixelColor = frame[i[0][0][1],i[0][0][0]-1]
        if(i[0][0][0] != 0 and ((pixelColor[0] == 32 and pixelColor[1] == 30 and pixelColor[2] == 18) or (pixelColor[0] == 139 and pixelColor[1] == 127 and pixelColor[2] == 61))):
